...
contract TestBehaviouralBiometricAuth is Test {
    ...
    bytes32[] data = [
        bytes32(0x0123456789012345678901234567890123456789012345678901234567890123),
        bytes32(0x0123456789012345678901234567890123456789012345678901234567890124),
        bytes32(0x0123456789012345678901234567890123456789012345678901234567890125)
    ];
